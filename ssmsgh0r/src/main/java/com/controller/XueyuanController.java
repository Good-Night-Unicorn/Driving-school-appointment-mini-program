...
public class XueyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueyuanEntity user = xueyuanService.selectOne(new EntityWrapper<XueyuanEntity>().eq("xueyuanhao", username));
    ...
    public R register(@RequestBody XueyuanEntity xueyuan){
    	...
    	XueyuanEntity user = xueyuanService.selectOne(new EntityWrapper<XueyuanEntity>().eq("xueyuanhao", xueyuan.getXueyuanhao()));
		if(user!=null) {
