...
public class JiaolianController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaolianEntity user = jiaolianService.selectOne(new EntityWrapper<JiaolianEntity>().eq("jiaolianzhanghao", username));
    ...
    public R register(@RequestBody JiaolianEntity jiaolian){
    	...
    	JiaolianEntity user = jiaolianService.selectOne(new EntityWrapper<JiaolianEntity>().eq("jiaolianzhanghao", jiaolian.getJiaolianzhanghao()));
		if(user!=null) {
