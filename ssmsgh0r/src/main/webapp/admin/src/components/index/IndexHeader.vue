	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(253, 253, 229, 1)","headFontSize":"20px","headUserInfoFontColor":"rgba(74, 50, 22, 1)","headBoxShadow":"0px 0px 0px 4px rgba(74, 50, 22, 1)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(74, 50, 22, 1)","headFontColor":"rgba(74, 50, 22, 1)","headTitleImg":false,"headHeight":"58px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"rgba(234,207,164, 1)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(74, 50, 22, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
