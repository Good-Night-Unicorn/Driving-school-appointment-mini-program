<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="科目编号" prop="kemubianhao">
            <el-input v-model="ruleForm.kemubianhao" 
                placeholder="科目编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kemubianhao" label="科目编号" prop="kemubianhao">
              <el-input v-model="ruleForm.kemubianhao" 
                placeholder="科目编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科目名称" prop="kemumingcheng">
          <el-input v-model="ruleForm.kemumingcheng" 
              placeholder="科目名称" clearable  :readonly="ro.kemumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科目名称" prop="kemumingcheng">
              <el-input v-model="ruleForm.kemumingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="科目分类" prop="kemufenlei">
          <el-select :disabled="ro.kemufenlei" v-model="ruleForm.kemufenlei" placeholder="请选择科目分类">
            <el-option
                v-for="(item,index) in kemufenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="科目分类" prop="kemufenlei">
	      <el-input v-model="ruleForm.kemufenlei"
                placeholder="科目分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试费" prop="kaoshifei">
          <el-input v-model="ruleForm.kaoshifei" 
              placeholder="考试费" clearable  :readonly="ro.kaoshifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试费" prop="kaoshifei">
              <el-input v-model="ruleForm.kaoshifei" 
                placeholder="考试费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="科目内容" prop="kemuneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kemuneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kemuneirong" label="科目内容" prop="kemuneirong">
                    <span v-html="ruleForm.kemuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kemuneirong = this.ruleForm.kemuneirong.replace(reg,'../../../ssmsgh0r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
