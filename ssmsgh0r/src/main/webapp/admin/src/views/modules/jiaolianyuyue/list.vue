  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="预约科目" prop="yuyuekemu">
		  <el-select  @change="yuyuekemuChange" clearable v-model="searchForm.yuyuekemu" placeholder="请选择预约科目">
		    <el-option
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.yuyuekemu!='' && this.searchForm.yuyuekemu!=undefined){
