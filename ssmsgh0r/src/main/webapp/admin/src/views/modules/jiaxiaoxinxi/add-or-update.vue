    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="驾校简介" prop="jiaxiaojianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaxiaojianjie" label="驾校简介" prop="jiaxiaojianjie">
                    <span v-html="ruleForm.jiaxiaojianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jiaxiaojianjie = this.ruleForm.jiaxiaojianjie.replace(reg,'../../../ssmsgh0r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
