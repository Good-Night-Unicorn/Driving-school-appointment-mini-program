<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="学员号" prop="xueyuanhao">
          <el-input v-model="ruleForm.xueyuanhao" readonly              placeholder="学员号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="教练账号" prop="jiaolianzhanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="个人介绍" prop="gerenjieshao">
          <el-input v-model="ruleForm.gerenjieshao"               placeholder="个人介绍" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.xueyuanhao)&& 'xueyuan'==this.flag){
