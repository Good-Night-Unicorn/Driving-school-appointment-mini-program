<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">微信小程序的驾校预约管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			   <div class="label">学员号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuanhao" class="input" type="text" placeholder="学员号">
			   </div>
			 </div> -->
			<el-form-item label="学员号" class="input" v-if="tableName=='xueyuan'">
			  <el-input v-model="ruleForm.xueyuanhao" autocomplete="off" placeholder="学员号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			...
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   <div class="label">教练账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaolianzhanghao" class="input" type="text" placeholder="教练账号">
			   </div>
			 </div> -->
			<el-form-item label="教练账号" class="input" v-if="tableName=='jiaolian'">
			  <el-input v-model="ruleForm.jiaolianzhanghao" autocomplete="off" placeholder="教练账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.xueyuanhao) && `xueyuan` == this.tableName){
        this.$message.error(`学员号不能为空`);
        return
      }
